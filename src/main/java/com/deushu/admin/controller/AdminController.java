...
public class AdminController {
    ...
    // ── 대시보드 ──
    @GetMapping("/api/admin/dashboard/stats") @ResponseBody
    public ApiResponse<?> getDashboardStats() { return ApiResponse.onSuccess(adminService.getDashboardStats()); }

    @GetMapping("/api/admin/dashboard/weekly-sales") @ResponseBody
    public ApiResponse<?> getWeeklySales() { return ApiResponse.onSuccess(adminService.getWeeklySales()); }

    @GetMapping("/api/admin/dashboard/category-stats") @ResponseBody
    public ApiResponse<?> getCategoryStats() { return ApiResponse.onSuccess(adminService.getCategoryOrderStats()); }

    // ── 회원 ──
    @GetMapping("/api/admin/members") @ResponseBody
    ...
    @PatchMapping("/api/admin/members/{id}/role") @ResponseBody
    ...
    @PatchMapping("/api/admin/members/{id}/esg-point") @ResponseBody
    ...
    @DeleteMapping("/api/admin/members/{id}") @ResponseBody
    ...
    // ── 가게 ──
    @GetMapping("/api/admin/stores") @ResponseBody
    ...
    @DeleteMapping("/api/admin/stores/{id}") @ResponseBody
    public ApiResponse<Void> deactivateStore(@PathVariable Long id) {
        adminService.deactivateStore(id);
        return ApiResponse.onSuccess(null);
    }

    @PatchMapping("/api/admin/stores/{id}/restore") @ResponseBody
    ...
    // ── 주문 ──
    @GetMapping("/api/admin/orders") @ResponseBody
    ...
    @PatchMapping("/api/admin/orders/{id}/status") @ResponseBody
    ...
    // ── 리뷰 ──
    @GetMapping("/api/admin/reviews") @ResponseBody
    ...
    @DeleteMapping("/api/admin/reviews/{id}") @ResponseBody
